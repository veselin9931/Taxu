        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocumentConfirmation = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    CurrentLocationLat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CurrentLocationLong = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDrivingNow = table.Column<bool>(type: "bit", nullable: false),
                    AlertTriggered = table.Column<bool>(type: "bit", nullable: false),
                    IsDriver = table.Column<bool>(type: "bit", nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrentLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChoosenLanguage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationLat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DestinationLong = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationLong = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IncreasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IncreasedByDriver = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IncreaseAccepted = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    IsDriverArrived = table.Column<bool>(type: "bit", nullable: false),
                    WithStroller = table.Column<bool>(type: "bit", nullable: false),
                    WithPets = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuspectedUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
