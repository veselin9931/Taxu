...
let TravelModePage = class TravelModePage {
    constructor(route, orderService, accountService, tripService, driverService, alertController, chatService, translate, popoverController) {
        this.route = route;
