  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-verifying-account-verifying-module"], {
    ...
    function NIQc(module, __webpack_exports__, __webpack_require__) {
      ...
      var AccountVerifyingPage = /*#__PURE__*/function () {
        function AccountVerifyingPage(route, accountService, driverService) {
        ...
        _createClass(AccountVerifyingPage, [{
          ...
          value: function getUser() {
            ...
            this.accountService.getById(this.user.id).subscribe(function (x) {
              _this.driverService.getDriver(x.driverId).subscribe(function (driver) {
                if (driver.documentConfirmation == true) {
                  _this.route.navigate(['menu/driver-profile']);
                }
