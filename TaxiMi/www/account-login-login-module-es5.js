      ...
      var LoginPage = /*#__PURE__*/function () {
        ...
        _createClass(LoginPage, [{
          ...
          value: function ngOnInit() {
            ...
            var connection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_6__["HubConnectionBuilder"]().configureLogging(_aspnet_signalr__WEBPACK_IMPORTED_MODULE_6__["LogLevel"].Information).withUrl("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].signalRUrl, "/orderHub")).build(); // const connection = new signalR.HubConnectionBuilder()
