    ...
    function roEg(module, __webpack_exports__, __webpack_require__) {
      ...
      var FavouriteOrdersPage = /*#__PURE__*/function () {
        ...
        _createClass(FavouriteOrdersPage, [{
          ...
          value: function deleteConfirmation(id) {
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      this.translate.get(['Delete from favourites?', 'Yes', 'No']).subscribe(function (text) {
                                  ...
                                  return this.alertController.create({
                                    ...
                                    buttons: [{
                                      ...
                                      handler: function handler() {
                                        _this7.subscriptions.push(_this7.orderService.deleteFavouriteOrder(id).subscribe(function (x) {
                                          _this7.successDeletedFavourite();
                                        }));
                                      }
                                    }, {
                                      text: text['No']
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      this.translate.get(['Successfully removed the trip!']).subscribe(function (text) {
