(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["travel-mode-travel-mode-module"], {
    ...
    function xo1A(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_models__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/_models */
      "VeQZ");
      /* harmony import */


      var src_services__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! src/_services */
      "8Xdb");
      /* harmony import */


      var src_services_chat_chat_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var src_services_order_order_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! src/_services/order/order.service */
      "8k+r");
      /* harmony import */


      var src_services_trip_trip_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      ...
      var TravelModePage = /*#__PURE__*/function () {
        function TravelModePage(route, orderService, accountService, tripService, driverService, alertController, chatService, translate, popoverController, callNumber) {
        ...
        _createClass(TravelModePage, [{
          ...
          value: function checkorder() {
            ...
            this.subscriptions.push(this.orderService.getMyOrder(this.user.id).subscribe(function (data) {
              if (data) {
                _this2.chatService.stop();

                _this2.chatService.start();
          ...
          value: function startTimer() {
            ...
            setInterval(function () {
              if (_this3.secsDiff == 300) {
                _this3.subscriptions.push(_this3.orderService.increaseOrderPrice(_this3.order.id, 1).subscribe(function () {}));
          ...
          value: function addToInbox(obj) {
            var newObj = new src_models__WEBPACK_IMPORTED_MODULE_10__["Message"]();
          ...
          value: function getUserById(driverId) {
            ...
            this.subscriptions.push(this.accountService.getById(driverId).subscribe(function (userData) {
              _this4.firstName = userData.firstName;
              _this4.lastName = userData.lastName;
              _this4.driverId = userData.driverId;
              _this4.phoneNumber = userData.phone;

              _this4.subscriptions.push(_this4.driverService.getDriverActiveCar(userData.driverId).subscribe(function (car) {
                _this4.carModel = car.model;
                _this4.carColor = car.color;
              }));
            }));
          }
        }, {
          ...
          value: function getAcceptedTrip(userId) {
            ...
            this.subscriptions.push(this.tripService.getTrip(userId).subscribe(function (x) {
              ...
              if (x.status == 'Started') {
                _this5.accountService.userValue.alertTriggered = false;

                _this5.subscriptions.push(_this5.accountService.updateAlert(_this5.user.id, false).subscribe(function () {}));
              }

              _this5.currentTrip = x;

              _this5.loadMap(_this5.mapRef, userId);
            }));
          }
        }, {
          key: "addToFavourite",
                  ...
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      this.subscriptions.push(this.accountService.getById(driverId).subscribe(function (driver) {
                        _this7.subscriptions.push(_this7.driverService.getDriver(driver.driverId).subscribe(function (data) {
                          var driverLatLng = {
                          ...
                          if (mapRef != null) {
                            _this7.map = new google.maps.Map(mapRef.nativeElement, options);
                          }
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this8.subscriptions.push(_this8.tripService.getTrip(_this8.orderAcceptedBy).subscribe(function (trip) {
                              _this8.subscriptions.push(_this8.tripService.cancelTrip(trip.id).subscribe(function (x) {
                                _this8.subscriptions.push(_this8.accountService.updateDriving(_this8.orderAcceptedBy, false).subscribe(function () {}));

                                _this8.accountService.userValue.isDrivingNow = false;

                                _this8.subscriptions.push(_this8.orderService.deleteOrder(trip.orderId).subscribe(function () {
                                  return _this8.route.navigate(['menu/travelling']);
                                }));
                              }));
                            }));
                          }
                    ...
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          role: 'cancel',
                          handler: function handler() {
                            _this9.subscriptions.push(_this9.driverService.voteUp(_this9.driverId).subscribe(function (x) {}));

                            _this9.route.navigate(['menu/travelling']);
                          ...
                          role: 'no',
                          handler: function handler() {
                            _this9.subscriptions.push(_this9.driverService.voteDown(_this9.driverId).subscribe(function (x) {}));
                          ...
                          role: 'cancel',
                          handler: function handler() {
                            _this9.route.navigate(['menu/report']);
                          }
                        }]
                      });
                    ...
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          text: 'Ok',
                          handler: function handler() {
                            _this10.route.navigate(['menu/travelling']);
                          }
                        }]
                      });
