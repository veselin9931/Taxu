...
module.exports = __webpack_require__(/*! C:\TAXI\Taxu\TaxiMi\src\main.ts */"zUnb");
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        const { SplashScreen, StatusBar } = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"];
        this.platform.ready().then(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield StatusBar.setStyle({ style: _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["StatusBarStyle"].Light });
            setTimeout(() => {
                SplashScreen.hide({
...
/* harmony import */ var _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/date-picker/ngx */ "ya1t");
...
/* harmony import */ var _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ionic-native/local-notifications/ngx */ "Bg0J");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_11__["DatePicker"],
...
let AccountService = class AccountService {
    ...
    updateToken(id, value) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl}/api/account/token/${id}/${value}`, { headers, responseType: 'json' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(x => {
            // update stored user if the logged in user updated their own record
            if (id == this.userValue.id) {
                // update local storage
