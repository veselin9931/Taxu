(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["menu-menu-module"], {
    ...
    function mU(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_location_accuracy_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      ...
      MenuPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _menu_routing_module__WEBPACK_IMPORTED_MODULE_5__["MenuPageRoutingModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"].forChild({
          loader: {
        ...
        providers: [_ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_12__["AndroidPermissions"], _ionic_native_background_mode_ngx__WEBPACK_IMPORTED_MODULE_14__["BackgroundMode"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_11__["Geolocation"], _ionic_native_location_accuracy_ngx__WEBPACK_IMPORTED_MODULE_13__["LocationAccuracy"]],
    ...
    function zJv(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ConnectivityProvider", function () {
      ...
      var ConnectivityProvider = /*#__PURE__*/function () {
        function ConnectivityProvider() {
          _classCallCheck(this, ConnectivityProvider);

          this.initConnectivityMonitoring();
        }

        _createClass(ConnectivityProvider, [{
      ...
      ConnectivityProvider.ctorParameters = function () {
        return [];
      };

      ConnectivityProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function Gpoy(module, __webpack_exports__, __webpack_require__) {
      ...
      var VERSION = "1.1.4"; //# sourceMappingURL=index.js.map
    ...
    /***/
    function Oq4w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function (_super) {
        ...
        return NodeHttpClient;
      }(_HttpClient__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]); //# sourceMappingURL=NodeHttpClient.js.map
    ...
    /***/
    function YoFb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function dhCI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      /*! ./XhrHttpClient */
      "YoFb"); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
      ...
      function (_super) {
        ...
        return DefaultHttpClient;
      }(_HttpClient__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]); //# sourceMappingURL=DefaultHttpClient.js.map
    ...
    function exMm(module, __webpack_exports__, __webpack_require__) {
      ...
      var DriverService = /*#__PURE__*/function () {
        function DriverService(http, sharedService) {
        ...
        _createClass(DriverService, [{
          ...
          value: function getDriverHistory(userId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/order/history/").concat(userId), {
              headers: headers
          ...
          value: function getDriver(driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver/").concat(driverId), {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "createDriver",
          value: function createDriver(data) {
            var headers = this.sharedService.headerGerneration();
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver"), data, {
              headers: headers,
              responseType: 'text'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
          ...
          key: "getDriverCars",
          value: function getDriverCars(driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/car/driver/").concat(driverId), {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "getDriverActiveCar",
          value: function getDriverActiveCar(driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/car/driver/active/").concat(driverId), {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "getDriverByReferral",
          value: function getDriverByReferral(referral) {
            var headers = this.sharedService.headerGerneration();
            return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver/referral/").concat(referral), {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "locateDriver",
          value: function locateDriver(driverId, lat, lng) {
            return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver/location/").concat(driverId, "/").concat(lat, "/").concat(lng), {
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "voteUp",
          value: function voteUp(driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver/voteUp/").concat(driverId), {
              headers: headers,
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
          ...
          key: "voteDown",
          value: function voteDown(driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver/voteDown/").concat(driverId), {
              headers: headers,
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "lowerDriverCommission",
          value: function lowerDriverCommission(driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/driver/").concat(driverId), {
              headers: headers,
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
          ...
          key: "activeCar",
          value: function activeCar(id, driverId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/car/").concat(id, "/").concat(driverId), {
              headers: headers,
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
          ...
          value: function createCar(data) {
            var headers = this.sharedService.headerGerneration();
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/car"), data, {
              headers: headers,
              responseType: 'text'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
          ...
          value: function deleteCar(id) {
            var headers = this.sharedService.headerGerneration();
            return this.http["delete"]("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/car/").concat(id), {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
        }, {
          key: "cancelOrderFromDriver",
          value: function cancelOrderFromDriver(orderId) {
            var headers = this.sharedService.headerGerneration();
            return this.http.put("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/api/order/waiting/").concat(orderId), {
              headers: headers,
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
          }
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("common"), __webpack_require__.e("destination-destination-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            ...
            /*! import() | account-login-login-module */
            "account-login-login-module").then(__webpack_require__.bind(null,
            /*! ../account/login/login.module */
            "xInB")).then(function (m) {
          ...
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | account-register-register-module */
            "account-register-register-module").then(__webpack_require__.bind(null,
            /*! ../account/register/register.module */
            "2w85")).then(function (m) {
          ...
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | travelling-travelling-module */
            "travelling-travelling-module").then(__webpack_require__.bind(null,
            /*! ../travelling/travelling.module */
            "JQQN")).then(function (m) {
              return m.TravellingPageModule;
            });
          }
        }, {
          path: 'driving',
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | driving-driving-module */
            [__webpack_require__.e("common"), __webpack_require__.e("driving-driving-module")]).then(__webpack_require__.bind(null,
            /*! ../driving/driving.module */
            "g7Ce")).then(function (m) {
          ...
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | account-verifying-account-verifying-module */
            "account-verifying-account-verifying-module").then(__webpack_require__.bind(null,
            /*! ../account-verifying/account-verifying.module */
            "nhYi")).then(function (m) {
              return m.AccountVerifyingPageModule;
            });
          }
        }, {
          path: 'become-driver',
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | become-driver-become-driver-module */
            [__webpack_require__.e("common"), __webpack_require__.e("become-driver-become-driver-module")]).then(__webpack_require__.bind(null,
            /*! ../become-driver/become-driver.module */
            "IEv6")).then(function (m) {
              return m.BecomeDriverPageModule;
            });
          }
        }, {
          path: 'driver-profile',
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | driver-profile-driver-profile-module */
            [__webpack_require__.e("common"), __webpack_require__.e("driver-profile-driver-profile-module")]).then(__webpack_require__.bind(null,
            /*! ../driver-profile/driver-profile.module */
            "5O4O")).then(function (m) {
              return m.DriverProfilePageModule;
            });
          }
        }, {
          path: 'driver-history',
          loadChildren: function loadChildren() {
            ...
            "driver-history-driver-history-module").then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | car-register-car-register-module */
            [__webpack_require__.e("common"), __webpack_require__.e("car-register-car-register-module")]).then(__webpack_require__.bind(null,
            /*! ../car-register/car-register.module */
            "vqOf")).then(function (m) {
              return m.CarRegisterPageModule;
            });
          }
        }, {
          path: 'report',
          ...
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | favourite-orders-favourite-orders-module */
            "favourite-orders-favourite-orders-module").then(__webpack_require__.bind(null,
            /*! ../favourite-orders/favourite-orders.module */
            "9Cmh")).then(function (m) {
              return m.FavouriteOrdersPageModule;
            });
          }
        }, {
          ...
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | payments-sucsses-payments-sucsses-module */
            "payments-sucsses-payments-sucsses-module").then(__webpack_require__.bind(null,
            /*! ../payments-sucsses/payments-sucsses.module */
            "9MWA")).then(function (m) {
              return m.PaymentsSucssesPageModule;
            });
          }
        }, {
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | travel-mode-travel-mode-module */
            [__webpack_require__.e("default~driving-mode-driving-mode-module~order-details-order-details-module~travel-mode-travel-mode-module"), __webpack_require__.e("common"), __webpack_require__.e("travel-mode-travel-mode-module")]).then(__webpack_require__.bind(null,
            /*! ../travel-mode/travel-mode.module */
            "y67D")).then(function (m) {
              return m.TravelModePageModule;
            });
          }
        }, {
          path: 'driving-mode',
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | driving-mode-driving-mode-module */
            [__webpack_require__.e("default~driving-mode-driving-mode-module~order-details-order-details-module~travel-mode-travel-mode-module"), __webpack_require__.e("common"), __webpack_require__.e("driving-mode-driving-mode-module")]).then(__webpack_require__.bind(null,
            /*! ../driving-mode/driving-mode.module */
            "xDpq")).then(function (m) {
              return m.DrivingModePageModule;
            });
          }
        }, {
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~driving-mode-driving-mode-module~order-details-order-details-module~travel-mode-travel-mode-module"), __webpack_require__.e("common"), __webpack_require__.e("order-details-order-details-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | out-of-town-out-of-town-module */
            [__webpack_require__.e("common"), __webpack_require__.e("out-of-town-out-of-town-module")]).then(__webpack_require__.bind(null,
            /*! ../out-of-town/out-of-town.module */
            "wZQh")).then(function (m) {
              return m.OutOfTownPageModule;
            });
          }
        }, {
          path: 'booked-travels',
          loadChildren: function loadChildren() {
            return __webpack_require__.e(
            /*! import() | booked-travels-booked-travels-module */
            "booked-travels-booked-travels-module").then(__webpack_require__.bind(null,
            /*! ../booked-travels/booked-travels.module */
            "mbC9")).then(function (m) {
              return m.BookedTravelsPageModule;
            });
          }
        }, {
          path: 'reservations',
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | reservations-reservations-module */
            [__webpack_require__.e("common"), __webpack_require__.e("reservations-reservations-module")]).then(__webpack_require__.bind(null,
            /*! ../reservations/reservations.module */
            "fgfA")).then(function (m) {
    ...
    function ylOD(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_services_connectivity_provider__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! src/_services/connectivity.provider */
      "4zJv");
      /* harmony import */
      ...
      var MenuPage = /*#__PURE__*/function () {
        function MenuPage(router, accountService, driverService, translate, popoverController, backgroundMode, alertController, connectivityProvider, localNotifications, platform) {
          var _this2 = this;
          ...
          this.subscriptions.push(this.router.events.subscribe(function (event) {
            if (event && event.url) {
              if (event.url == "/menu/driving") {
                if (_this2.isLoggedIn && _this2.isVerified && _this2.documentConfirmed && _this2.driverCars.length >= 1) {
          ...
          platform.ready().then(function () {
            _this2.localNotifications.requestPermission();

            _this2.backgroundMode.enable();
          });
        }
        ...
        _createClass(MenuPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.checkValues();
            var connection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_5__["HubConnectionBuilder"]().configureLogging(_aspnet_signalr__WEBPACK_IMPORTED_MODULE_5__["LogLevel"].Information).withUrl("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].signalRUrl, "/orderHub"), {
              skipNegotiation: false,
              transport: _aspnet_signalr__WEBPACK_IMPORTED_MODULE_5__["HttpTransportType"].WebSockets | _aspnet_signalr__WEBPACK_IMPORTED_MODULE_5__["HttpTransportType"].LongPolling
            }).build();
            ...
            connection.on('LoggedIn', function () {
              _this3.checkValues();
            });
          ...
          value: function checkInternetConnection() {
            ...
            this.connectivityProvider.appIsOnline$.subscribe(function (online) {
              if (online) {
                console.log('im online'); // call functions or methods that need to execute when app goes online (such as sync() etc)
              } else {
                _this4.noInternetAccess();
              }
            });
          }
        }, {
          ...
          value: function checkValues() {
            ...
            if (this.isLoggedIn) {
              this.subscriptions.push(this.accountService.getById(this.accountService.userValue.id).subscribe(function (x) {
                _this5.isVerified = x.isDriver;

                if (x.driverId != null) {
                  _this5.subscriptions.push(_this5.driverService.getDriver(x.driverId).subscribe(function (d) {
                    _this5.subscriptions.push(_this5.driverService.getDriverCars(x.driverId).subscribe(function (cars) {
                      _this5.driverCars = cars;
                    }));

                    _this5.documentConfirmed = d.documentConfirmation;
                  }));
                }
              }));
          ...
          key: "noInternetAccess",
          value: function noInternetAccess() {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      this.translate.get(['No internet access!', 'Please connect to internet and try again!']).subscribe(function (text) {
          ...
          value: function logout() {
            ...
            this.isLoggedIn = "";
            this.router.navigate(['menu/home']).then(function () {
