(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\TAXI\Taxu\TaxiMi\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, translate) {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _alert_alert_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _alert_alert_component__WEBPACK_IMPORTED_MODULE_9__["AlertComponent"]],
        entryComponents: [],
        ...
        providers: [_ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_12__["AndroidPermissions"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_10__["Geolocation"], _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_16__["LocalNotifications"], _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_11__["DatePicker"], _ionic_native_location_accuracy_ngx__WEBPACK_IMPORTED_MODULE_13__["LocationAccuracy"], {
    ...
    function mpGk(module, __webpack_exports__, __webpack_require__) {
      ...
      var AccountService = /*#__PURE__*/function () {
        ...
        _createClass(AccountService, [{
          ...
          key: "updateToken",
          value: function updateToken(id, value) {
            var _this7 = this;

            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
              'Content-Type': 'application/json'
            });
            return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl, "/api/account/token/").concat(id, "/").concat(value), {
              headers: headers,
              responseType: 'json'
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (x) {
              // update stored user if the logged in user updated their own record
          ...
          value: function updateLanguage(id, value) {
            ...
            return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl, "/api/account/").concat(id, "/language/").concat(value), {
              ...
              if (id == _this8.userValue.id) {
                // update local storage
                var user = Object.assign(Object.assign({}, _this8.userValue), {
                  value: value
                });
                localStorage.setItem('user', JSON.stringify(user)); // publish updated user to subscribers
