(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["car-register-car-register-module"], {
    ...
    function hbCy(module, __webpack_exports__, __webpack_require__) {
      ...
      var _language_popover_language_popover_page__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      ...
      var CarRegisterPage = /*#__PURE__*/function () {
        function CarRegisterPage(route, formBuilder, driverService, accountService, location, imageService, alertController, popoverController, translate) {
        ...
        _createClass(CarRegisterPage, [{
          ...
          key: "ionViewDidEnter",
          value: function ionViewDidEnter() {// this.clearCarImages();
          }
        }, {
          key: "f",
          get: function get() {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.popoverController.create({
                        component: _language_popover_language_popover_page__WEBPACK_IMPORTED_MODULE_14__["LanguagePopoverPage"],
                        event: ev
                      });
                                  ...
                                  return this.alertController.create({
                                    ...
                                    buttons: [{
                                      ...
                                      handler: function handler() {
                                        _this7.imageService.removeDocument(id).subscribe(function (x) {
                                          console.log('Image removed sucessfully');
                                        });
                                      }
                                    }, {
    ...
    /*! exports provided: HttpLoaderFactory, CarRegisterPageModule */
