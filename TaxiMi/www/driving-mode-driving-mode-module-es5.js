        ...
        _createClass(DrivingModePage, [{
                  ...
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 4:
                      ...
                      directionsService.route({
                        ...
                        if (status === "OK") {
                          _this2.subscriptions.push(_this2.tripService.navigateToUser(_this2.currentTrip.id, _this2.order.id).subscribe(function () {
                            if (_capacitor_core__WEBPACK_IMPORTED_MODULE_5__["Capacitor"].getPlatform() === 'ios') {
                              window.open("http://maps.apple.com/maps?q=".concat(userLat, ",").concat(userLng, "&t=m&dirflg=d"));
          ...
          value: function startTrip() {
            ...
            this.subscriptions.push(this.tripService.startTrip(this.currentTrip.id).subscribe(function (trip) {
              if (trip) {
                _this4.tripStatus = trip.status;

                _this4.subscriptions.push(_this4.walletService.dischargeWallet(_this4.applicationUserId, _this4.tripPriceForDriver).subscribe(function (x) {
                  _this4.subscriptions.push(_this4.profitService.addToProfit(_this4.tripPriceForDriver).subscribe(function () {}));
                }));
              }
            }));
          }
                  ...
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 3:
                      ...
                      directionsService.route({
                        ...
                        if (status === "OK") {
                          _this5.eta = response.routes[0].legs[0].duration.text;
                          ...
                          _this5.distance = order.distanceText;
                        }
                      });
          ...
          value: function getAcceptedTrip() {
            ...
            this.subscriptions.push(this.tripService.getTrip(this.driverId).subscribe(function (x) {
              ...
              _this6.chatService.stop();

              _this6.chatService.start();

              _this6.tripStatus = x.status;
              _this6.currentTrip = x;

              _this6.subscriptions.push(_this6.orderService.getOrderById(x.orderId).subscribe(function (order) {
                if (order != null) {
                  x.order = order;
                  _this6.order = x.order;
                  _this6.location = order.location;
                  _this6.destination = order.destination;
                  _this6.totalPrice = order.totalPrice;
                  _this6.userLatitude = order.locationLat;
                  _this6.userLongitude = order.locationLong;
                  _this6.userDestinationLat = order.destinationLat;
                  _this6.userDestinationLng = order.destinationLong;
                  _this6.tripDistance = order.tripDistance;

                  _this6.calculateEta(order);

                  _this6.subscriptions.push(_this6.driverService.getDriver(_this6.accountService.userValue.driverId).subscribe(function (s) {
                    _this6.tripPriceForDriver = order.totalPrice * (s.comission / 100);
                  }));
                }
              }));
            }));
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this8.subscriptions.push(_this8.accountService.updateDriving(_this8.applicationUserId, false).subscribe(function () {
                              _this8.route.navigate(['menu/driving']);
                            }));
                          }
                        }]
                      });
                    ...
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          role: 'cancel',
                          handler: function handler() {
                            _this9.subscriptions.push(_this9.tripService.completeTrip(_this9.currentTrip.id).subscribe(function (trip) {
                              if (trip) {
                                _this9.tripStatus = trip.status;
                              }

                              _this9.subscriptions.push(_this9.orderService.completeOrder(_this9.currentTrip.orderId).subscribe(function () {})); //trigger the driver's driving now property to false


                              //trigger the driver's driving now property to false
                              var userId = _this9.accountService.userValue.id;
                              var value = _this9.accountService.userValue.isDrivingNow = false;

                              _this9.subscriptions.push(_this9.accountService.updateDriving(userId, value).subscribe());

                              _this9.isDrivingNow = _this9.accountService.userValue.isDrivingNow;
